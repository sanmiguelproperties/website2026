...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const colorKeyLabels = {
    ...
    'card_line': 'Linea de tarjetas',
    'focus_card_bg': 'Enfoque - tarjeta fondo',
    'focus_card_border': 'Enfoque - tarjeta borde',
    'focus_label': 'Enfoque - etiqueta',
    'focus_title': 'Enfoque - titulo',
    'focus_text': 'Enfoque - texto',
    'history_title': 'Historia - titulo',
    'history_text': 'Historia - texto',
    'mission_title': 'Mision - titulo',
    'mission_text': 'Mision - texto',
    'vision_title': 'Vision - titulo',
    'vision_text': 'Vision - texto',
    'bio': 'Biografia',
    'email': 'Email',
    'button_bg': 'Boton - fondo',
    'button_text': 'Boton - texto',
    'empty_card_bg': 'Estado vacio - tarjeta fondo',
    'empty_card_border': 'Estado vacio - tarjeta borde',
