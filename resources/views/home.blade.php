...
<section id="servicios" class="py-20 lg:py-28" style="background-color: var(--fe-services-bg, #ffffff);">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center max-w-3xl mx-auto mb-16">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium mb-4" style="background-color: var(--fe-services-badge_bg, #eef2ff); color: var(--fe-services-badge_text, #4f46e5);">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="group relative p-8 rounded-2xl border transition-all duration-300 hover:shadow-xl" style="background: linear-gradient(to bottom right, var(--fe-services-card_bg_from, #f8fafc), var(--fe-services-card_bg_to, #ffffff)); border-color: var(--fe-services-card_border, #f1f5f9);">
                <div class="w-14 h-14 rounded-xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-300" style="background: linear-gradient(to bottom right, var(--fe-services-feature1_from, #4f46e5), var(--fe-services-feature1_to, #818cf8));">
                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                    </svg>
                </div>
                <h3 class="text-xl font-bold mb-3" style="color: var(--fe-services-card_title, #0f172a);">Búsqueda Inteligente</h3>
                <p style="color: var(--fe-services-card_text, #475569);">Filtros avanzados y búsqueda por mapa para encontrar exactamente lo que necesitas en segundos.</p>
                <div class="absolute top-4 right-4 w-20 h-20 rounded-full blur-2xl transition-colors" style="background-color: var(--fe-services-feature1_glow, rgba(79, 70, 229, 0.05));"></div>
            </div>

            {{-- Feature 2 - Transacciones Seguras --}}
            <div class="group relative p-8 rounded-2xl border transition-all duration-300 hover:shadow-xl" style="background: linear-gradient(to bottom right, var(--fe-services-card_bg_from, #f8fafc), var(--fe-services-card_bg_to, #ffffff)); border-color: var(--fe-services-card_border, #f1f5f9);">
                <div class="w-14 h-14 rounded-xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-300" style="background: linear-gradient(to bottom right, var(--fe-services-feature2_from, #059669), var(--fe-services-feature2_to, #34d399));">
                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                    </svg>
                </div>
                <h3 class="text-xl font-bold mb-3" style="color: var(--fe-services-card_title, #0f172a);">Transacciones Seguras</h3>
                <p style="color: var(--fe-services-card_text, #475569);">Proceso de compra transparente con asesoría legal incluida y documentación verificada.</p>
                <div class="absolute top-4 right-4 w-20 h-20 rounded-full blur-2xl transition-colors" style="background-color: var(--fe-services-feature2_glow, rgba(5, 150, 105, 0.05));"></div>
            </div>

            {{-- Feature 3 - Tours Virtuales --}}
            <div class="group relative p-8 rounded-2xl border transition-all duration-300 hover:shadow-xl" style="background: linear-gradient(to bottom right, var(--fe-services-card_bg_from, #f8fafc), var(--fe-services-card_bg_to, #ffffff)); border-color: var(--fe-services-card_border, #f1f5f9);">
                <div class="w-14 h-14 rounded-xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-300" style="background: linear-gradient(to bottom right, var(--fe-services-feature3_from, #9333ea), var(--fe-services-feature3_to, #c084fc));">
                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                    </svg>
                </div>
                <h3 class="text-xl font-bold mb-3" style="color: var(--fe-services-card_title, #0f172a);">Tours Virtuales 360°</h3>
                <p style="color: var(--fe-services-card_text, #475569);">Recorre las propiedades desde la comodidad de tu hogar con nuestros tours virtuales inmersivos.</p>
                <div class="absolute top-4 right-4 w-20 h-20 rounded-full blur-2xl transition-colors" style="background-color: var(--fe-services-feature3_glow, rgba(147, 51, 234, 0.05));"></div>
            </div>

            {{-- Feature 4 - Asesores Expertos --}}
            <div class="group relative p-8 rounded-2xl border transition-all duration-300 hover:shadow-xl" style="background: linear-gradient(to bottom right, var(--fe-services-card_bg_from, #f8fafc), var(--fe-services-card_bg_to, #ffffff)); border-color: var(--fe-services-card_border, #f1f5f9);">
                <div class="w-14 h-14 rounded-xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-300" style="background: linear-gradient(to bottom right, var(--fe-services-feature4_from, #f59e0b), var(--fe-services-feature4_to, #fbbf24));">
                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
                </div>
                <h3 class="text-xl font-bold mb-3" style="color: var(--fe-services-card_title, #0f172a);">Asesores Expertos</h3>
                <p style="color: var(--fe-services-card_text, #475569);">Un equipo de profesionales certificados te acompaña en cada paso del proceso.</p>
                <div class="absolute top-4 right-4 w-20 h-20 rounded-full blur-2xl transition-colors" style="background-color: var(--fe-services-feature4_glow, rgba(245, 158, 11, 0.05));"></div>
            </div>

            {{-- Feature 5 - Financiamiento Flexible --}}
            <div class="group relative p-8 rounded-2xl border transition-all duration-300 hover:shadow-xl" style="background: linear-gradient(to bottom right, var(--fe-services-card_bg_from, #f8fafc), var(--fe-services-card_bg_to, #ffffff)); border-color: var(--fe-services-card_border, #f1f5f9);">
                <div class="w-14 h-14 rounded-xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-300" style="background: linear-gradient(to bottom right, var(--fe-services-feature5_from, #f43f5e), var(--fe-services-feature5_to, #fb7185));">
                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                </div>
                <h3 class="text-xl font-bold mb-3" style="color: var(--fe-services-card_title, #0f172a);">Financiamiento Flexible</h3>
                <p style="color: var(--fe-services-card_text, #475569);">Opciones de crédito con las mejores tasas del mercado y planes a tu medida.</p>
                <div class="absolute top-4 right-4 w-20 h-20 rounded-full blur-2xl transition-colors" style="background-color: var(--fe-services-feature5_glow, rgba(244, 63, 94, 0.05));"></div>
            </div>

            {{-- Feature 6 - App Móvil --}}
            <div class="group relative p-8 rounded-2xl border transition-all duration-300 hover:shadow-xl" style="background: linear-gradient(to bottom right, var(--fe-services-card_bg_from, #f8fafc), var(--fe-services-card_bg_to, #ffffff)); border-color: var(--fe-services-card_border, #f1f5f9);">
                <div class="w-14 h-14 rounded-xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-300" style="background: linear-gradient(to bottom right, var(--fe-services-feature6_from, #06b6d4), var(--fe-services-feature6_to, #22d3ee));">
                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                    </svg>
                </div>
                <h3 class="text-xl font-bold mb-3" style="color: var(--fe-services-card_title, #0f172a);">App Móvil</h3>
                <p style="color: var(--fe-services-card_text, #475569);">Gestiona tus favoritos, agenda visitas y recibe alertas desde cualquier lugar.</p>
                <div class="absolute top-4 right-4 w-20 h-20 rounded-full blur-2xl transition-colors" style="background-color: var(--fe-services-feature6_glow, rgba(6, 182, 212, 0.05));"></div>
            </div>
        </div>
    </div>
</section>
...
<section id="venta" class="relative py-24 lg:py-32 overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        ...
        <div class="absolute inset-0" style="background: linear-gradient(to right, var(--fe-cta_sale-overlay_from, rgba(49, 46, 129, 0.95)), var(--fe-cta_sale-overlay_via, rgba(49, 46, 129, 0.8)), var(--fe-cta_sale-overlay_to, transparent));"></div>
    </div>

    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl">
            {{-- Badge --}}
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full backdrop-blur-sm text-sm font-medium mb-6" style="background: var(--fe-cta_sale-badge_bg, rgba(255,255,255,0.1)); color: var(--fe-cta_sale-badge_text, #34d399);">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
    ...
    <div class="absolute bottom-0 right-0 w-1/3 h-full hidden lg:block">
        ...
        <div class="absolute bottom-20 right-20 w-64 h-64 rounded-3xl" style="border: 2px solid var(--fe-cta_sale-decor, rgba(16, 185, 129, 0.2));"></div>
    </div>
</section>
...
<section id="renta" class="relative py-24 lg:py-32 overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        ...
        <div class="absolute inset-0" style="background: linear-gradient(to left, var(--fe-cta_rent-overlay_from, rgba(15, 23, 42, 0.95)), var(--fe-cta_rent-overlay_via, rgba(15, 23, 42, 0.8)), var(--fe-cta_rent-overlay_to, transparent));"></div>
    </div>

    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl ml-auto text-right">
            {{-- Badge --}}
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full backdrop-blur-sm text-sm font-medium mb-6" style="background: var(--fe-cta_rent-badge_bg, rgba(255,255,255,0.1)); color: var(--fe-cta_rent-badge_text, #fbbf24);">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex flex-wrap justify-end gap-4 mb-10">
                <div class="flex items-center gap-2 text-white/80">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: var(--fe-cta_rent-check_color, #fbbf24);">
    ...
    <div class="absolute bottom-0 left-0 w-1/3 h-full hidden lg:block">
        ...
        <div class="absolute bottom-20 left-20 w-64 h-64 rounded-3xl" style="border: 2px solid var(--fe-cta_rent-decor, rgba(245, 158, 11, 0.2));"></div>
    </div>
</section>
...
<section id="propiedades" class="py-20 lg:py-28" style="background: linear-gradient(to bottom, var(--fe-properties-bg_from, #f8fafc), var(--fe-properties-bg_to, #ffffff));">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center max-w-3xl mx-auto mb-12">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium mb-4" style="background-color: var(--fe-properties-badge_bg, #eef2ff); color: var(--fe-properties-badge_text, #4f46e5);">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                </svg>
                Catálogo de Propiedades
            </div>
            <h2 class="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4" style="color: var(--fe-properties-title, #0f172a);">
                Explora nuestras propiedades
            </h2>
            <p class="text-lg" style="color: var(--fe-properties-subtitle, #475569);">
            ...
            <div class="rounded-2xl border p-6 shadow-sm" style="background-color: var(--fe-properties-filter_bg, #ffffff); border-color: var(--fe-properties-filter_border, #e2e8f0);">
                <div class="flex flex-wrap items-center gap-4">
                    ...
                    <button @click="clearFilters()"
                            ...
                            style="color: var(--fe-properties-filter_clear, #475569);">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
{{-- ============================================== --}}
<section class="py-20 lg:py-28 relative overflow-hidden" style="background-color: var(--fe-process-bg, #0f172a);">
    {{-- Animated Background --}}
    <div class="absolute inset-0 pointer-events-none">
        <div class="absolute top-0 left-1/4 w-96 h-96 rounded-full blur-3xl animate-float" style="background-color: var(--fe-process-glow1, rgba(79, 70, 229, 0.2));"></div>
        <div class="absolute bottom-0 right-1/4 w-96 h-96 rounded-full blur-3xl animate-float" style="animation-delay: -3s; background-color: var(--fe-process-glow2, rgba(16, 185, 129, 0.2));"></div>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {{-- Section Header --}}
        <div class="text-center max-w-3xl mx-auto mb-16">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium mb-4" style="background: var(--fe-process-badge_bg, rgba(255,255,255,0.1)); color: var(--fe-process-badge_text, #34d399);">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="relative group">
                <div class="absolute -inset-1 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-300" style="background: linear-gradient(to right, var(--fe-process-step1_from, #4f46e5), var(--fe-process-step1_to, #818cf8));"></div>
                <div class="relative backdrop-blur-sm rounded-2xl p-8 h-full" style="background: var(--fe-process-card_bg, rgba(30, 41, 59, 0.5)); border: 1px solid var(--fe-process-card_border, rgba(51, 65, 85, 0.5));">
                    <div class="w-12 h-12 rounded-xl flex items-center justify-center text-white text-xl font-bold mb-6" style="background: linear-gradient(to bottom right, var(--fe-process-step1_from, #4f46e5), var(--fe-process-step1_to, #818cf8));">
                        1
                    </div>
                ...
                {{-- Connector --}}
                <div class="hidden lg:block absolute top-1/2 -right-4 w-8 h-0.5" style="background: linear-gradient(to right, var(--fe-process-step1_from, #4f46e5), transparent);"></div>
            </div>

            {{-- Step 2 --}}
            <div class="relative group">
                <div class="absolute -inset-1 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-300" style="background: linear-gradient(to right, var(--fe-process-step2_from, #9333ea), var(--fe-process-step2_to, #c084fc));"></div>
                <div class="relative backdrop-blur-sm rounded-2xl p-8 h-full" style="background: var(--fe-process-card_bg, rgba(30, 41, 59, 0.5)); border: 1px solid var(--fe-process-card_border, rgba(51, 65, 85, 0.5));">
                    <div class="w-12 h-12 rounded-xl flex items-center justify-center text-white text-xl font-bold mb-6" style="background: linear-gradient(to bottom right, var(--fe-process-step2_from, #9333ea), var(--fe-process-step2_to, #c084fc));">
                        2
                    </div>
                ...
                {{-- Connector --}}
                <div class="hidden lg:block absolute top-1/2 -right-4 w-8 h-0.5" style="background: linear-gradient(to right, var(--fe-process-step2_from, #9333ea), transparent);"></div>
            </div>

            {{-- Step 3 --}}
            <div class="relative group">
                <div class="absolute -inset-1 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-300" style="background: linear-gradient(to right, var(--fe-process-step3_from, #0891b2), var(--fe-process-step3_to, #22d3ee));"></div>
                <div class="relative backdrop-blur-sm rounded-2xl p-8 h-full" style="background: var(--fe-process-card_bg, rgba(30, 41, 59, 0.5)); border: 1px solid var(--fe-process-card_border, rgba(51, 65, 85, 0.5));">
                    <div class="w-12 h-12 rounded-xl flex items-center justify-center text-white text-xl font-bold mb-6" style="background: linear-gradient(to bottom right, var(--fe-process-step3_from, #0891b2), var(--fe-process-step3_to, #22d3ee));">
                        3
                    </div>
                ...
                {{-- Connector --}}
                <div class="hidden lg:block absolute top-1/2 -right-4 w-8 h-0.5" style="background: linear-gradient(to right, var(--fe-process-step3_from, #0891b2), transparent);"></div>
            </div>

            {{-- Step 4 --}}
            <div class="relative group">
                <div class="absolute -inset-1 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-300" style="background: linear-gradient(to right, var(--fe-process-step4_from, #059669), var(--fe-process-step4_to, #34d399));"></div>
                <div class="relative backdrop-blur-sm rounded-2xl p-8 h-full" style="background: var(--fe-process-card_bg, rgba(30, 41, 59, 0.5)); border: 1px solid var(--fe-process-card_border, rgba(51, 65, 85, 0.5));">
                    <div class="w-12 h-12 rounded-xl flex items-center justify-center text-white text-xl font-bold mb-6" style="background: linear-gradient(to bottom right, var(--fe-process-step4_from, #059669), var(--fe-process-step4_to, #34d399));">
                        4
                    </div>
        ...
        <div class="text-center mt-16">
            <a href="#contacto" class="inline-flex items-center gap-2 px-8 py-4 text-white font-semibold rounded-xl hover:shadow-lg transition-all duration-300 hover:scale-105" style="background: linear-gradient(to right, var(--fe-primary-from, #4f46e5), var(--fe-primary-to, #10b981));">
                Comenzar ahora
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="rounded-2xl p-8 border relative" style="background: linear-gradient(to bottom right, var(--fe-testimonials-card_bg_from, #f8fafc), var(--fe-testimonials-card_bg_to, #ffffff)); border-color: var(--fe-testimonials-card_border, #f1f5f9);">
                ...
                <div class="flex items-center gap-1 mb-4">
                    @for($i = 0; $i < 5; $i++)
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" style="color: var(--fe-testimonials-stars, #fbbf24);">
                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                        </svg>
                    @endfor
                </div>
                <p class="mb-6 relative z-10" style="color: var(--fe-testimonials-card_text, #475569);">
                ...
                <div class="flex items-center gap-4">
                    <div class="w-12 h-12 rounded-full flex items-center justify-center text-white font-bold" style="background: linear-gradient(to bottom right, var(--fe-testimonials-avatar1_from, #4f46e5), var(--fe-testimonials-avatar1_to, #10b981));">
                        MG
                    </div>
                    <div>
                        <div class="font-semibold" style="color: var(--fe-testimonials-name, #0f172a);">María García</div>
                        <div class="text-sm" style="color: var(--fe-testimonials-role, #64748b);">Compradora - Polanco</div>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-2xl p-8 border relative" style="background: linear-gradient(to bottom right, var(--fe-testimonials-card_bg_from, #f8fafc), var(--fe-testimonials-card_bg_to, #ffffff)); border-color: var(--fe-testimonials-card_border, #f1f5f9);">
                ...
                <div class="flex items-center gap-4">
                    <div class="w-12 h-12 rounded-full flex items-center justify-center text-white font-bold" style="background: linear-gradient(to bottom right, var(--fe-testimonials-avatar2_from, #9333ea), var(--fe-testimonials-avatar2_to, #ec4899));">
                        CR
                    </div>
                    <div>
                        <div class="font-semibold" style="color: var(--fe-testimonials-name, #0f172a);">Carlos Rodríguez</div>
                        <div class="text-sm" style="color: var(--fe-testimonials-role, #64748b);">Inversionista - Santa Fe</div>
                    </div>
                </div>
            </div>
            ...
            {{-- Testimonial 3 --}}
            <div class="rounded-2xl p-8 border relative" style="background: linear-gradient(to bottom right, var(--fe-testimonials-card_bg_from, #f8fafc), var(--fe-testimonials-card_bg_to, #ffffff)); border-color: var(--fe-testimonials-card_border, #f1f5f9);">
                <div class="absolute top-6 right-6 text-6xl font-serif" style="color: var(--fe-testimonials-quote3, #f3e8ff);">"</div>
                <div class="flex items-center gap-1 mb-4">
                    @for($i = 0; $i < 5; $i++)
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" style="color: var(--fe-testimonials-stars, #fbbf24);">
                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                ...
                <div class="flex items-center gap-4">
                    <div class="w-12 h-12 rounded-full flex items-center justify-center text-white font-bold" style="background: linear-gradient(to bottom right, var(--fe-testimonials-avatar3_from, #f59e0b), var(--fe-testimonials-avatar3_to, #f97316));">
                        AL
                    </div>
                    <div>
                        <div class="font-semibold" style="color: var(--fe-testimonials-name, #0f172a);">Ana López</div>
                        <div class="text-sm" style="color: var(--fe-testimonials-role, #64748b);">Arrendataria - Condesa</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div class="relative">
                <div class="relative rounded-3xl overflow-hidden shadow-2xl">
                    ...
                    <div class="absolute inset-0" style="background: linear-gradient(to top, var(--fe-about-image_overlay, rgba(15, 23, 42, 0.6)), transparent);"></div>
                ...
                <div class="absolute -bottom-6 -right-6 rounded-2xl shadow-xl p-6 max-w-xs hidden lg:block" style="background-color: var(--fe-about-card_bg, #ffffff);">
                    <div class="flex items-center gap-4">
                        <div class="w-16 h-16 rounded-xl flex items-center justify-center text-white" style="background: linear-gradient(to bottom right, var(--fe-primary-from, #4f46e5), var(--fe-primary-to, #10b981));">
                            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
                            </svg>
                        </div>
                        <div>
                            <div class="text-2xl font-bold" style="color: var(--fe-about-card_title, #0f172a);">98%</div>
                            <div class="text-sm" style="color: var(--fe-about-card_text, #475569);">Satisfacción de clientes</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {{-- Content Side --}}
            <div>
                <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium mb-6" style="background-color: var(--fe-about-badge_bg, #e0e7ff); color: var(--fe-about-badge_text, #4f46e5);">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
                    Sobre Nosotros
                ...
                <div class="space-y-4 mb-8">
                    <div class="flex items-start gap-4">
                        <div class="w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0" style="background-color: var(--fe-about-value1_bg, #e0e7ff); color: var(--fe-about-value1_icon, #4f46e5);">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                        </div>
                        <div>
                            <h4 class="font-semibold" style="color: var(--fe-about-value_title, #0f172a);">Transparencia total</h4>
                            <p class="text-sm" style="color: var(--fe-about-value_text, #475569);">Sin costos ocultos. Toda la información que necesitas, cuando la necesitas.</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4">
                        <div class="w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0" style="background-color: var(--fe-about-value2_bg, #d1fae5); color: var(--fe-about-value2_icon, #059669);">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                        </div>
                        <div>
                            <h4 class="font-semibold" style="color: var(--fe-about-value_title, #0f172a);">Asesoría personalizada</h4>
                            <p class="text-sm" style="color: var(--fe-about-value_text, #475569);">Un asesor dedicado que entiende tus necesidades y te guía en cada paso.</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4">
                        <div class="w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0" style="background-color: var(--fe-about-value3_bg, #f3e8ff); color: var(--fe-about-value3_icon, #9333ea);">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                        </div>
                        <div>
                            <h4 class="font-semibold" style="color: var(--fe-about-value_title, #0f172a);">Tecnología innovadora</h4>
                            <p class="text-sm" style="color: var(--fe-about-value_text, #475569);">Herramientas digitales que simplifican la búsqueda y el proceso de compra.</p>
                        </div>
                    </div>
                </div>
...
<section id="contacto" class="py-20 lg:py-28" style="background-color: var(--fe-contact-bg, #ffffff);">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-20">
            {{-- Contact Info --}}
            <div>
                <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium mb-6" style="background-color: var(--fe-contact-badge_bg, #eef2ff); color: var(--fe-contact-badge_text, #4f46e5);">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-y-6">
                    <a href="tel:+525512345678" class="flex items-center gap-4 p-4 rounded-xl transition-colors group" style="background-color: var(--fe-contact-method_bg, #f8fafc);">
                        <div class="w-12 h-12 rounded-xl flex items-center justify-center text-white group-hover:scale-110 transition-transform" style="background: linear-gradient(to bottom right, var(--fe-contact-phone_from, #10b981), var(--fe-contact-phone_to, #059669));">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                            </svg>
                        </div>
                        <div>
                            <p class="font-semibold" style="color: var(--fe-contact-method_title, #0f172a);">Teléfono</p>
                            <p style="color: var(--fe-contact-method_text, #475569);">+52 55 1234 5678</p>
                        </div>
                    </a>
                    ...
                    <a href="https://wa.me/525512345678" target="_blank" class="flex items-center gap-4 p-4 rounded-xl transition-colors group" style="background-color: var(--fe-contact-method_bg, #f8fafc);">
                        <div class="w-12 h-12 rounded-xl flex items-center justify-center text-white group-hover:scale-110 transition-transform" style="background: linear-gradient(to bottom right, var(--fe-contact-whatsapp_from, #22c55e), var(--fe-contact-whatsapp_to, #16a34a));">
                        ...
                        <div>
                            <p class="font-semibold" style="color: var(--fe-contact-method_title, #0f172a);">WhatsApp</p>
                            <p style="color: var(--fe-contact-method_text, #475569);">Chatea con nosotros</p>
                        </div>
                    </a>
                    ...
                    <a href="mailto:info@sanmiguelproperties.com" class="flex items-center gap-4 p-4 rounded-xl transition-colors group" style="background-color: var(--fe-contact-method_bg, #f8fafc);">
                        <div class="w-12 h-12 rounded-xl flex items-center justify-center text-white group-hover:scale-110 transition-transform" style="background: linear-gradient(to bottom right, var(--fe-contact-email_from, #6366f1), var(--fe-contact-email_to, #4f46e5));">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                            </svg>
                        </div>
                        <div>
                            <p class="font-semibold" style="color: var(--fe-contact-method_title, #0f172a);">Email</p>
                            <p style="color: var(--fe-contact-method_text, #475569);">info@sanmiguelproperties.com</p>
                        </div>
                    </a>
                </div>
            </div>
            ...
            <div class="rounded-3xl p-8 lg:p-10 border shadow-lg" style="background: linear-gradient(to bottom right, var(--fe-contact-form_bg_from, #f8fafc), var(--fe-contact-form_bg_to, #ffffff)); border-color: var(--fe-contact-form_border, #f1f5f9);">
                <form class="space-y-6">
                    <div class="grid sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="contact_name" name="name" required
                                   ...
                                   style="background-color: var(--fe-contact-input_bg, #ffffff); border: 1px solid var(--fe-contact-input_border, #e2e8f0); color: var(--fe-contact-input_text, #0f172a);"
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <label for="contact_privacy" class="text-sm" style="color: var(--fe-contact-privacy_text, #475569);">
                            Acepto la <a href="#" style="color: var(--fe-contact-link, #4f46e5);" class="hover:underline">política de privacidad</a> y autorizo el tratamiento de mis datos.
                        </label>
                    </div>
            ...
            return `
                <div class="property-card rounded-2xl overflow-hidden border shadow-sm group" style="background-color: var(--fe-properties-card_bg, #ffffff); border-color: var(--fe-properties-card_border, #f1f5f9);">
                    <div class="relative h-56 overflow-hidden">
                        ...
                        <span class="absolute top-4 left-4 px-3 py-1 backdrop-blur-sm text-xs font-medium rounded-full" style="background-color: var(--fe-properties-type_badge_bg, rgba(255,255,255,0.9)); color: var(--fe-properties-type_badge_text, #0f172a);">
                            ${property.property_type_name}
                        </span>
                        ` : ''}
                        
                        ${operationType ? `
                        <span class="absolute top-4 right-4 px-3 py-1 text-white text-xs font-semibold rounded-full" style="background-color: ${operationType === 'sale' ? 'var(--fe-properties-sale_badge, #10b981)' : 'var(--fe-properties-rent_badge, #f59e0b)'};">
                            ${operationType === 'sale' ? 'En Venta' : 'En Renta'}
                        </span>
                        ` : ''}
                        
                        <button class="absolute bottom-4 right-4 w-10 h-10 rounded-full backdrop-blur-sm flex items-center justify-center transition-colors opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 duration-300" style="background-color: var(--fe-properties-fav_btn_bg, rgba(255,255,255,0.9)); color: var(--fe-properties-fav_btn_icon, #475569);">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="p-6">
                        ...
                        <h3 class="text-lg font-bold mb-3 line-clamp-2 transition-colors" style="color: var(--fe-properties-card_title, #0f172a);">
                            ${property.title || 'Propiedad disponible'}
                        </h3>
                        
                        <div class="text-2xl font-bold text-transparent bg-clip-text mb-4" style="background-image: linear-gradient(to right, var(--fe-primary-from, #4f46e5), var(--fe-primary-to, #10b981));">
                            ${price}
                        </div>
                        
                        <div class="flex items-center gap-4 text-sm border-t pt-4" style="color: var(--fe-properties-card_meta, #475569); border-color: var(--fe-properties-card_divider, #f1f5f9);">
                        ...
                        <div class="mt-5">
                            <a href="/propiedades/${property.id}" class="inline-flex items-center justify-center gap-2 w-full px-4 py-3 rounded-xl text-white font-semibold transition-all duration-300 hover:shadow-lg hover:scale-[1.02]" style="background: linear-gradient(to right, var(--fe-primary-from, #4f46e5), var(--fe-primary-to, #10b981));">
                                Ver detalles
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
                                </svg>
