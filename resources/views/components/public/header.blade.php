    ...
    <nav class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-20 items-center justify-between">
            ...
            <a href="{{ url('/') }}" class="flex items-center gap-3 group">
                <div class="grid h-11 w-11 place-items-center rounded-xl bg-gradient-to-br from-indigo-600 to-emerald-500 text-white shadow-lg transition-transform duration-300 group-hover:scale-105">
            ...
            <div class="hidden lg:flex lg:items-center lg:gap-1">
                <a href="{{ url('/') }}" 
                   :class="{ 'text-slate-700 hover:text-indigo-600': scrolled, 'text-white/90 hover:text-white': !scrolled }"
                   class="relative px-4 py-2 text-sm font-medium transition-colors duration-200 rounded-lg hover:bg-slate-900/5">
                    Inicio
                </a>
                <a href="#propiedades" 
                   :class="{ 'text-slate-700 hover:text-indigo-600': scrolled, 'text-white/90 hover:text-white': !scrolled }"
            ...
            <div class="flex items-center gap-4">
                ...
                @auth
                    <a href="{{ url('/dashboard') }}" 
                       class="hidden sm:inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-emerald-500 px-5 py-2.5 text-sm font-semibold text-white shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105 focus:outline-none focus:ring-4 focus:ring-indigo-500/20">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div x-show="mobileMenuOpen" 
            ...
            <div class="px-4 py-6 space-y-1">
                ...
                {{-- Login Button --}}
                @auth
                    <a href="{{ url('/dashboard') }}" class="flex items-center justify-center gap-2 mt-4 w-full rounded-xl bg-gradient-to-r from-indigo-600 to-emerald-500 px-5 py-3 text-sm font-semibold text-white shadow-lg">
                ...
                @else
                    <a href="{{ route('login') }}" class="flex items-center justify-center gap-2 mt-4 w-full rounded-xl bg-gradient-to-r from-indigo-600 to-emerald-500 px-5 py-3 text-sm font-semibold text-white shadow-lg">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" />
                        </svg>
                        Acceder al Portal
