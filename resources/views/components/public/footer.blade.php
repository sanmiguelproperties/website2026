...
<footer class="relative bg-slate-900 text-white overflow-hidden">
    ...
    <div class="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div class="absolute -bottom-40 -left-40 w-80 h-80 bg-emerald-500/20 rounded-full blur-3xl"></div>
        ...
        <div class="border-b border-white/10">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
                <div class="max-w-3xl mx-auto text-center">
                    <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-indigo-600/20 to-emerald-500/20 text-sm font-medium text-emerald-400 mb-6">
                    ...
                    <h3 class="text-2xl sm:text-3xl font-bold mb-4">
                        ...
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-emerald-400">newsletter</span>
                    </h3>
                    ...
                    <form class="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                        ...
                        <button type="submit" class="px-6 py-3.5 bg-gradient-to-r from-indigo-600 to-emerald-500 rounded-xl font-semibold text-white hover:shadow-lg hover:shadow-indigo-500/25 transition-all duration-300 hover:scale-105">
                            Suscribirse
                        </button>
                    </form>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
                ...
                <div class="lg:col-span-1">
                    <a href="{{ url('/') }}" class="flex items-center gap-3 mb-6 group">
                        <div class="grid h-12 w-12 place-items-center rounded-xl bg-gradient-to-br from-indigo-600 to-emerald-500 text-white shadow-lg transition-transform duration-300 group-hover:scale-105">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="#" class="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-slate-400 hover:bg-indigo-600 hover:text-white transition-all duration-300" aria-label="Facebook">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                            </svg>
                        </a>
                        <a href="#" class="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-slate-400 hover:bg-gradient-to-r hover:from-purple-600 hover:to-pink-500 hover:text-white transition-all duration-300" aria-label="Instagram">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="#" class="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-slate-400 hover:bg-sky-500 hover:text-white transition-all duration-300" aria-label="Twitter">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                            </svg>
                        </a>
                        <a href="#" class="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-slate-400 hover:bg-green-500 hover:text-white transition-all duration-300" aria-label="WhatsApp">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="#" class="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-slate-400 hover:bg-blue-600 hover:text-white transition-all duration-300" aria-label="LinkedIn">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    <h4 class="text-white font-semibold text-lg mb-6 flex items-center gap-2">
                        <span class="w-8 h-0.5 bg-gradient-to-r from-indigo-600 to-emerald-500 rounded-full"></span>
                        Enlaces Rápidos
                    </h4>
                    <ul class="space-y-3">
                        <li>
                    ...
                    <ul class="space-y-3">
                        <li>
                            <a href="#" class="text-slate-400 hover:text-white transition-colors duration-200 flex items-center gap-2 group">
                                <svg class="w-4 h-4 text-emerald-500 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                                </svg>
                                Casas
                            </a>
                    ...
                    <ul class="space-y-4">
                        <li>
                            <a href="tel:+525512345678" class="flex items-start gap-3 text-slate-400 hover:text-white transition-colors duration-200 group">
                                <div class="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-emerald-500 group-hover:bg-emerald-500 group-hover:text-white transition-all duration-300 flex-shrink-0">
                        ...
                        <li>
                            <a href="mailto:info@sanmiguelproperties.com" class="flex items-start gap-3 text-slate-400 hover:text-white transition-colors duration-200 group">
                                <div class="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-indigo-500 group-hover:bg-indigo-500 group-hover:text-white transition-all duration-300 flex-shrink-0">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                    </svg>
                                </div>
                        ...
                        <li>
                            <div class="flex items-start gap-3 text-slate-400">
                                <div class="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-indigo-500 flex-shrink-0">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <li>
                            <div class="flex items-start gap-3 text-slate-400">
                                <div class="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-emerald-500 flex-shrink-0">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
