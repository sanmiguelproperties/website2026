...
@php
  ...
  $wrapperBase = 'rounded-2xl border border-[var(--c-border)] p-4 bg-[var(--c-surface)]';
  $inputBase = 'w-full rounded-lg border border-[var(--c-border)] px-3 py-2 bg-[var(--c-elev)] text-[var(--c-text)] placeholder:text-[var(--c-muted)] focus:ring-2 focus:ring-[var(--c-primary)] focus:border-transparent';
  $buttonBase = 'px-3 py-2 rounded-lg bg-[var(--c-primary)] text-[var(--c-primary-ink)] hover:opacity-95 shadow';
