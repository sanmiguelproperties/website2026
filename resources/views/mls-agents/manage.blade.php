      ...
      <form id="agent-form" class="flex-1 min-h-0 overflow-y-auto">
        ...
        <section class="agent-tab-panel p-6 space-y-5" data-panel="datos">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label class="block text-sm font-medium mb-1">Biografía (EN)</label>
              <textarea id="field-bio" rows="4" class="w-full px-3 py-2 rounded-xl bg-[var(--c-elev)] border border-[var(--c-border)]" placeholder="Bio del agente en inglés…"></textarea>
            </div>
            <div>
              <label class="block text-sm font-medium mb-1">Biografía (ES)</label>
              <textarea id="field-bio-es" rows="4" class="w-full px-3 py-2 rounded-xl bg-[var(--c-elev)] border border-[var(--c-border)]" placeholder="Bio del agente en español…"></textarea>
            </div>
          </div>
        </section>
