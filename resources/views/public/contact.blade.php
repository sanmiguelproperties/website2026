...
<section class="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
    <div class="absolute inset-0 z-0">
        <div class="absolute inset-0" style="background: linear-gradient(135deg, var(--fe-contact_page-hero_bg_from, #1C1C1C) 0%, var(--fe-contact_page-hero_bg_via, #D1A054) 50%, var(--fe-contact_page-hero_bg_to, #768D59) 100%);"></div>
        <div class="absolute inset-0 [background-size:40px_40px]" style="background-image: radial-gradient(circle at 1px 1px, var(--fe-contact_page-hero_pattern_dot, rgba(255,255,255,0.1)) 1px, transparent 0);"></div>
    </div>
...
<section class="py-16 lg:py-24" style="background-color: var(--fe-contact_page-section_bg, #ffffff);">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-5 gap-12 lg:gap-16">
        <div class="lg:col-span-2 space-y-8">
            <div>
                <h2 class="text-2xl sm:text-3xl font-bold mb-4" style="color: var(--fe-contact_page-section_title, #1C1C1C);">
                    {{ $txt('contact_info_title', 'Informacion de contacto', 'Contact information') }}
                </h2>
                <p class="text-lg" style="color: var(--fe-contact_page-section_text, #475569);">
            ...
            <div class="space-y-4">
                <a href="tel:{{ $phoneHref }}" class="group flex items-start gap-4 p-5 rounded-2xl border transition-all duration-300 hover:shadow-lg" style="background: linear-gradient(to bottom right, var(--fe-contact_page-card_bg_from, #f8fafc), var(--fe-contact_page-card_bg_to, #ffffff)); border-color: var(--fe-contact_page-card_border, #e2e8f0);">
                    <div class="w-14 h-14 rounded-xl flex items-center justify-center text-white flex-shrink-0" style="background: linear-gradient(to bottom right, var(--fe-contact_page-info_icon_phone_from, var(--fe-contact_page-info_icon_phone, #768D59)), var(--fe-contact_page-info_icon_phone_to, var(--fe-contact_page-info_icon_phone, #768D59)));">
                        <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                    </div>
                    <div>
                        <h3 class="font-semibold text-lg mb-1" style="color: var(--fe-contact_page-card_title, #1C1C1C);">{{ $txt('contact_label_phone', 'Telefono', 'Phone') }}</h3>
                        <p class="text-lg font-medium" style="color: var(--fe-contact_page-card_value_phone, var(--fe-contact_page-card_value, #D1A054));">{{ $phoneDisplay }}</p>
                    </div>
                </a>
                ...
                <a href="https://wa.me/{{ $whatsappNumber }}" target="_blank" rel="noopener" class="group flex items-start gap-4 p-5 rounded-2xl border transition-all duration-300 hover:shadow-lg" style="background: linear-gradient(to bottom right, var(--fe-contact_page-card_bg_from, #f8fafc), var(--fe-contact_page-card_bg_to, #ffffff)); border-color: var(--fe-contact_page-card_border, #e2e8f0);">
                    <div class="w-14 h-14 rounded-xl flex items-center justify-center text-white flex-shrink-0" style="background: linear-gradient(to bottom right, var(--fe-contact_page-info_icon_whatsapp_from, #22c55e), var(--fe-contact_page-info_icon_whatsapp_to, #16a34a));">
                    ...
                    <div>
                        <h3 class="font-semibold text-lg mb-1" style="color: var(--fe-contact_page-card_title, #1C1C1C);">{{ $txt('contact_label_whatsapp', 'WhatsApp', 'WhatsApp') }}</h3>
                        <p class="text-lg font-medium" style="color: var(--fe-contact_page-card_value_whatsapp, var(--fe-contact_page-card_value, #22c55e));">{{ $txt('contact_label_chat', 'Chatea con nosotros', 'Chat with us') }}</p>
                    </div>
                </a>

                <a href="mailto:{{ $email }}" class="group flex items-start gap-4 p-5 rounded-2xl border transition-all duration-300 hover:shadow-lg" style="background: linear-gradient(to bottom right, var(--fe-contact_page-card_bg_from, #f8fafc), var(--fe-contact_page-card_bg_to, #ffffff)); border-color: var(--fe-contact_page-card_border, #e2e8f0);">
                    <div class="w-14 h-14 rounded-xl flex items-center justify-center text-white flex-shrink-0" style="background: linear-gradient(to bottom right, var(--fe-contact_page-info_icon_email_from, var(--fe-contact_page-info_icon_email, #D1A054)), var(--fe-contact_page-info_icon_email_to, var(--fe-contact_page-info_icon_email, #D1A054)));">
                    ...
                    <div>
                        <h3 class="font-semibold text-lg mb-1" style="color: var(--fe-contact_page-card_title, #1C1C1C);">{{ $txt('contact_label_email', 'Email', 'Email') }}</h3>
                        <p class="text-lg font-medium" style="color: var(--fe-contact_page-card_value_email, var(--fe-contact_page-card_value, #D1A054));">{{ $email }}</p>
                    </div>
                </a>
            </div>
        ...
        <div class="lg:col-span-3">
            <div class="rounded-3xl p-8 lg:p-10 border shadow-xl" style="background: linear-gradient(to bottom right, var(--fe-contact_page-form_bg_from, #ffffff), var(--fe-contact_page-form_bg_to, #f8fafc)); border-color: var(--fe-contact_page-form_border, #e2e8f0);">
                <div class="mb-8">
                    <h2 class="text-2xl sm:text-3xl font-bold mb-2" style="color: var(--fe-contact_page-form_title, #1C1C1C);">
                        {{ $txt('contact_form_title', 'Envianos un mensaje', 'Send us a message') }}
                    </h2>
                    <p style="color: var(--fe-contact_page-form_subtitle, #475569);">
                ...
                <form id="contactForm" class="space-y-6" x-data="contactForm()">
                    <div x-show="success" x-cloak class="p-4 rounded-xl" style="background-color: var(--fe-contact_page-alert_success_bg, #d1fae5); color: var(--fe-contact_page-alert_success_text, #065f46);">
                        <span class="font-medium" x-text="successMessage"></span>
                    </div>

                    <div x-show="error" x-cloak class="p-4 rounded-xl" style="background-color: var(--fe-contact_page-alert_error_bg, #fee2e2); color: var(--fe-contact_page-alert_error_text, #991b1b);">
                        <span class="font-medium" x-text="errorMessage"></span>
                    </div>

                    <div class="grid sm:grid-cols-2 gap-6">
                        <div>
                            <label for="name" class="block text-sm font-semibold mb-2" style="color: var(--fe-contact_page-label, #334155);">{{ $txt('contact_form_label_name', 'Nombre completo', 'Full name') }} <span style="color: var(--fe-contact_page-required_mark, #ef4444);">*</span></label>
                            <input type="text" id="name" name="name" x-model="form.name" required class="w-full px-4 py-3.5 rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-0" style="background-color: var(--fe-contact_page-input_bg, #f8fafc); border: 1px solid var(--fe-contact_page-input_border, #e2e8f0); color: var(--fe-contact_page-input_text, #1C1C1C); --tw-ring-color: var(--fe-contact_page-form_focus_border, #D1A054);" :placeholder="labels.namePlaceholder">
                        </div>
                        <div>
                            <label for="phone" class="block text-sm font-semibold mb-2" style="color: var(--fe-contact_page-label, #334155);">{{ $txt('contact_label_phone', 'Telefono', 'Phone') }} <span style="color: var(--fe-contact_page-required_mark, #ef4444);">*</span></label>
                            <input type="tel" id="phone" name="phone" x-model="form.phone" required class="w-full px-4 py-3.5 rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-0" style="background-color: var(--fe-contact_page-input_bg, #f8fafc); border: 1px solid var(--fe-contact_page-input_border, #e2e8f0); color: var(--fe-contact_page-input_text, #1C1C1C); --tw-ring-color: var(--fe-contact_page-form_focus_border, #D1A054);" :placeholder="labels.phonePlaceholder">
                        </div>
                    </div>

                    <div>
                        <label for="email" class="block text-sm font-semibold mb-2" style="color: var(--fe-contact_page-label, #334155);">{{ $txt('contact_form_label_email', 'Correo electronico', 'Email') }} <span style="color: var(--fe-contact_page-required_mark, #ef4444);">*</span></label>
                        <input type="email" id="email" name="email" x-model="form.email" required class="w-full px-4 py-3.5 rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-0" style="background-color: var(--fe-contact_page-input_bg, #f8fafc); border: 1px solid var(--fe-contact_page-input_border, #e2e8f0); color: var(--fe-contact_page-input_text, #1C1C1C); --tw-ring-color: var(--fe-contact_page-form_focus_border, #D1A054);" :placeholder="labels.emailPlaceholder">
                    </div>

                    <div>
                        <label for="interest" class="block text-sm font-semibold mb-2" style="color: var(--fe-contact_page-label, #334155);">{{ $txt('contact_form_label_interest', 'Estoy interesado en', 'I am interested in') }}</label>
                        <select id="interest" name="interest" x-model="form.interest" class="w-full px-4 py-3.5 rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-0" style="background-color: var(--fe-contact_page-input_bg, #f8fafc); border: 1px solid var(--fe-contact_page-input_border, #e2e8f0); color: var(--fe-contact_page-input_text, #1C1C1C); --tw-ring-color: var(--fe-contact_page-form_focus_border, #D1A054);">
                    ...
                    <div>
                        <label for="message" class="block text-sm font-semibold mb-2" style="color: var(--fe-contact_page-label, #334155);">{{ $txt('contact_form_label_message', 'Mensaje', 'Message') }} <span style="color: var(--fe-contact_page-required_mark, #ef4444);">*</span></label>
                        <textarea id="message" name="message" x-model="form.message" rows="5" required class="w-full px-4 py-3.5 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-offset-0" style="background-color: var(--fe-contact_page-input_bg, #f8fafc); border: 1px solid var(--fe-contact_page-input_border, #e2e8f0); color: var(--fe-contact_page-input_text, #1C1C1C); --tw-ring-color: var(--fe-contact_page-form_focus_border, #D1A054);" :placeholder="labels.messagePlaceholder"></textarea>
                    </div>

                    <div class="flex items-start gap-3">
                        <input type="checkbox" id="privacy" name="privacy" x-model="form.privacy" required class="mt-1 h-5 w-5 rounded" style="border-color: var(--fe-contact_page-checkbox_border, #cbd5e1); accent-color: var(--fe-contact_page-checkbox_accent, #D1A054);">
                        <label for="privacy" class="text-sm" style="color: var(--fe-contact_page-privacy_text, #475569);">
...
<section class="py-16 lg:py-24" style="background: linear-gradient(to bottom, var(--fe-contact_page-faq_bg_from, #f8fafc), var(--fe-contact_page-faq_bg_to, #ffffff));">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="text-3xl sm:text-4xl font-bold mb-4" style="color: var(--fe-contact_page-faq_title, #1C1C1C);">
        ...
        <div class="space-y-4" x-data="{ openFaq: null }">
            @foreach($faqItems as $index => $faq)
                <div class="rounded-2xl border overflow-hidden" style="border-color: var(--fe-contact_page-faq_border, #e2e8f0);">
                    <button @click="openFaq = openFaq === {{ $index }} ? null : {{ $index }}" class="w-full flex items-center justify-between p-6 text-left" :style="openFaq === {{ $index }} ? 'background: linear-gradient(to right, var(--fe-contact_page-faq_item_open_from, rgba(209,160,84,0.05)), var(--fe-contact_page-faq_item_open_to, rgba(118,141,89,0.05)))' : 'background-color: var(--fe-contact_page-faq_item_bg, #ffffff)'">
                        <span class="font-semibold text-lg pr-4" style="color: var(--fe-contact_page-faq_question, #1C1C1C);">{{ $faq['q'] }}</span>
                        <svg class="w-6 h-6 flex-shrink-0 transition-transform duration-300" :class="{ 'rotate-180': openFaq === {{ $index }} }" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: var(--fe-contact_page-faq_icon, #D1A054);"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                    </button>
                    <div x-show="openFaq === {{ $index }}" x-collapse x-cloak>
                        <div class="px-6 pb-6" style="color: var(--fe-contact_page-faq_answer, #475569);">{{ $faq['a'] }}</div>
                    </div>
                </div>
            @endforeach
        </div>
        ...
        <div class="text-center mt-10">
            <a href="https://wa.me/{{ $whatsappNumber }}" target="_blank" rel="noopener" class="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-semibold text-white transition-all duration-300 hover:shadow-lg hover:scale-105" style="background: linear-gradient(to right, var(--fe-contact_page-submit_button_from, #D1A054), var(--fe-contact_page-submit_button_to, #768D59));">
