...
class ContactRequestController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'property_context' => ['nullable', 'string', Rule::in(array_keys(ContactRequest::propertyContextLabels()))],
    ...
    public function update(Request $request, ContactRequest $contactRequest): JsonResponse
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'referrer_url' => 'sometimes|nullable|string|max:2048',
            'lead_type' => ['sometimes', 'nullable', 'string', Rule::in(array_keys(ContactRequest::leadTypeLabels()))],
            'contact_type' => ['sometimes', 'nullable', 'string', Rule::in(array_keys(ContactRequest::contactTypeLabels()))],
            'property_context' => ['sometimes', 'nullable', 'string', Rule::in(array_keys(ContactRequest::propertyContextLabels()))],
            'interest' => 'sometimes|nullable|string|max:100',
            ...
            'privacy_accepted_at' => 'sometimes|nullable|date',
