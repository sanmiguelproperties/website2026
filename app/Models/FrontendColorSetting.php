    ...
    public static function getAvailableViews(): array
    {
        return [
            ...
            'about' => [
                ...
                'description' => 'Colores para la página Nosotros separados por sección',
                'groups' => ['about_hero', 'about_identity', 'about_brokers', 'about_team', 'about_agents'],
            ],
            'sell-with-us' => [
    ...
    public static function getDefaultColors(): array
    {
        return [
            ...
            'about_hero' => [
                ...
                'focus_card_bg' => 'rgba(15,23,42,0.45)',
                'focus_card_border' => 'rgba(255,255,255,0.18)',
                'focus_label' => 'rgba(255,255,255,0.72)',
                'focus_title' => '#ffffff',
                'focus_text' => 'rgba(255,255,255,0.78)',
            ],
            'about_identity' => [
                'section_bg' => '#f8fafc',
                'card_bg' => '#ffffff',
                'card_border' => '#e2e8f0',
                'card_line' => '#D1A054',
                'history_title' => '#0f172a',
                'history_text' => '#475569',
                'mission_title' => '#0f172a',
                'mission_text' => '#334155',
                'vision_title' => '#0f172a',
                'vision_text' => '#334155',
            ],
            ...
            'about_agents' => [
                ...
                'empty_card_bg' => 'rgba(15,23,42,0.40)',
                'empty_card_border' => 'rgba(255,255,255,0.20)',
                'empty_title' => '#ffffff',
                'empty_text' => 'rgba(255,255,255,0.75)',
                'card_bg' => 'rgba(15,23,42,0.45)',
                'card_border' => 'rgba(255,255,255,0.20)',
                'name' => '#ffffff',
                'email' => 'rgba(255,255,255,0.74)',
                'button_bg' => '#D1A054',
                'button_text' => '#ffffff',
            ],
